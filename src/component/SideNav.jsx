    ...
    return (
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap component="div">
                        Dashboard Punto de Venta Univer
                    </Typography>
                </Toolbar>
            </AppBar>
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    {
                        itemIconNavBar.items.map((item) => (
                        <ListItem key={item.desc} disablePadding sx={{ display: 'block' }}>
                            <ListItemButton
                                sx={{
                                    minHeight: 48,
                            ...
                            >
                                ...
                                <ListItemText primary={item.desc} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
                    ))}
                </List>
